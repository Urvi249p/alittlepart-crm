  ...
  return (
    <div>
      ...
      {filteredOrders.length === 0 ? (
        ...
        <GroupedView canEdit={canEdit} groupedOrders={groupedOrders} openEditForm={openEditForm} setConfirmDelete={setConfirmDelete} quickStatusChange={quickStatusChange} getSourceLabel={getSourceLabel} />
      ) : (
        <OrderTable canEdit={canEdit} filteredOrders={filteredOrders} openEditForm={openEditForm} setConfirmDelete={setConfirmDelete} quickStatusChange={quickStatusChange} getSourceLabel={getSourceLabel} />
      )}
