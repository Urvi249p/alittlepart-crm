...
export default function Toolbar({
  ...
  return (
    <div className="flex flex-col gap-3 mb-4 md:flex-row md:flex-nowrap md:items-center">
      <div className="flex flex-col gap-2 sm:flex-row md:flex-1 md:min-w-0">
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-4 rounded-lg border text-sm focus:outline-none focus:ring-2"
        ...
        <select
          ...
          className="w-full h-10 sm:w-auto md:w-36 px-3 rounded-lg border text-sm bg-white focus:outline-none focus:ring-2"
      ...
      <div className="flex flex-wrap items-center gap-4 md:flex-nowrap md:shrink-0">
        <div className="flex flex-wrap items-center gap-2 md:flex-nowrap">
          <button onClick={exportCSV} title="Export CSV" className="h-10 flex items-center justify-center gap-1.5 px-3 rounded-lg text-xs border font-medium whitespace-nowrap transition hover:bg-white" style={{ borderColor: colors.coralLight, color: colors.coralDark, backgroundColor: 'white' }}>
            <Download className="w-3.5 h-3.5" /> Export CSV
          </button>
          <button onClick={handleBackup} title="Backup" className="h-10 flex items-center justify-center gap-1.5 px-3 rounded-lg text-xs border font-medium whitespace-nowrap transition hover:bg-white" style={{ borderColor: colors.coralLight, color: colors.coralDark, backgroundColor: 'white' }}>
